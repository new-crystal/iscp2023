                        ...
                        <div class="airplane_cont">
                            ...
                            <div class="table_wrap detail_table_common x_scroll">
                                <table class="table type1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="venue_airplane" src="./img/venue_airplane1.svg" alt="" style="width: 90%;"></td>
                                        ...
                                        <tr>
                                            <td><img class="venue_airplane" src="./img/venue_airplane2.svg" alt="" style="width: 90%;"></td>
                                            <td>Approx. T2: 78 min <br>Approx. T1: 70 min</td>
                                        ...
                                        <tr>
                                            <td><img class="venue_airplane" src="./img/venue_airplane3.svg" alt="" style="width: 90%;"></td>
                            ...
                            <div class="table_wrap detail_table_common x_scroll">
                                <table class="table type2">
                                    <thead>
                                        ...
                                        <tr>
                                            <th style="border-left: 1px solid #fff;">Terminal 1</th>
                                            <th>Terminal 2</th>
                                        </tr>
                                    </thead>
                                    <tbody>
