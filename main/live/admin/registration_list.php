		...
		<div class="container">
			...
			<div class="contwrap">
				...
				<table id="datatable" class="list_table">
					...
					?>
						<tr class="tr_center">
							<td class="<?=$payment_status == "결제대기" ? "red_color" : "blue_color"?>"><?=isset($payment_status) ? $payment_status : "-" ?></td>
							<td><a href="./member_detail.php?idx=<?=isset($list["member_idx"]) ? $list["member_idx"] : "" ?>"><?=isset($list["member_email"]) ? $list["member_email"] : "-" ?></a></td>
							...
							<td><a href="./registration_detail.php?idx=<?=isset($list["idx"]) ? $list["idx"] : ""?>"><?= ($list['invitation_yn'] == 'Y' ? "Yes" : "No")?></a></td>
