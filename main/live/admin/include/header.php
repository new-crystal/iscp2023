    ...
    <ul>
        ...
        <li class="main_nav"><a href="javascript:;"><i class="la la-list"></i>신청서관리<i class="la la-angle-down"></i></a>
            <ul class="sub_nav">
                ...
                <li class="apply_poster"><a href="./abstract_application_list2.php">Poster Abstract Submission</a></li>
		...
		-->
        <li class="main_nav"><a href="javascript:;"><i class="la la-clipboard"></i>게시판관리<i
