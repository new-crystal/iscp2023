...
function timetableWeek(el, tiva_timetables, firstDayWeek) {
	...
	if (date_start == 'sunday') {
		wordDay = new Array(Room1, Room2, Room3, Room4, Room5);
		dayArr = new Array("Room 1", "Room 2", "Room 3", "Room 4", "Room 5");
	} else { // Start with Room 1
		wordDay = new Array(Room1, Room2, Room3, Room4, Room5);
		dayArr = new Array("Room 1", "Room 2", "Room 3", "Room 4", "Room 5");
	}
			...
			for (var m = 0; m < wordDay.length; m++) {
				...
				timetableString += '<div class="timetable-column">';
					...
					timetableString += '<div class="timetable-column-grid">';
						for (var n = min_time; n < (max_time * 2); n++) {
