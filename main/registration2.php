...
<form name="order_info" method="post" action="./plugin/NHNKCP/sample/pp_cli_hub.php">
	<div class="inner bottom_short">
		<div class="input_area">
			...
			?>
						<button id="pc_payment_btn" type="button" class="btn green_btn pc-wd-3" onclick="jsf__pay(document.order_info);">
							Payment
						</button>
			<?php
					}
		...
		<!--결제 정보 -->
		<input type="radio" id="radio-2-1" class="ipt-radio-1" name="pay_method" value="100000000000" <?= ($payment_methods==0 ? "checked" : "")?> />
		<input type="radio" id="radio-2-2" class="ipt-radio-1" name="pay_method" value="010000000000" <?= ($payment_methods==1 ? "checked" : "")?>/> 
