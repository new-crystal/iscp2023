...
<div style="width:1122px; height:793px; background:url('./img/img_certifi_bg.jpg') no-repeat center /contain; padding:146px 60px 84px; box-sizing:border-box;">
	<p style="font-family:'Montserrat', sans-serif; font-size:0; font-weight:bold; text-align:center; position:relative; padding:11px 0 13px; border-top:1px solid #e1c1a6; border-bottom:1px solid #e1c1a6; max-width:395px; margin:0 auto 28px;" >
		...
		<span style="font-family:inherit; font-size:24px; font-weight:inherit;"> APSAVD</span>
		<img style="position:absolute; left:50%; transform:translateX(-50%); top:-20px;" src="./img/icon_certifi_title.svg" alt="">
	</p>
	<p style="font-family: Noto Serif, serif; font-size:40px; font-weight:bold; color:#422918; text-align:center; margin:0; line-height:1.5;">Certificate of Attendance
	...
	<ul style="text-align:center; padding-left:0;">
		<li style="font-family: Noto Serif, serif; list-style:none; font-size:14px; margin:0 0 26px 0; font-weight:bold;">This certificate is presented to</li>
	...
	<p></p>
	<p style="font-family: Noto Serif, serif; font-size:13px; font-weight:bold; line-height:23px; text-align:center; margin-top:60px; color:#422918;">for attending the 11th International Congress on Lipid & Atherosclerosis<br/>with Asian-Pacific Society of Atherosclerosis and Vascular Disease<br/>held on September 15-17, 2022 in Seoul, Korea.</p>
...
<script>
	function CreatePDFfromHTML() {
		...
		window.location.replace("pre_registration_confirm2.php?key="+key+"&idx="+idx);
	}
</script>