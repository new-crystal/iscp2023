...
//    error_log(print_r($abstract_list_query, TRUE), 3, '/tmp/errors.log');
	...
	$html .= '<th style="background-color:#D9E1F2; border-style: solid; border-width:thin;" colspan="9">Abstract</th>';
	...
	$html .= '<th style="background-color:#E7E6E6; border-style: solid; border-width:thin;" colspan="5">Others</th>';
	...
	$html .= '<th style="background-color:#CC66E1; border-style: solid; border-width:thin;">ICoLA Grant</th>';
