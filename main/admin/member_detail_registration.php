                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>Password *</th>
                            <td class="input_wrap"><input type="password" name="<?=$member_idx ? "" : "password"?>"
                                    id="password" class="width_30" placeholder=""><input type="password"
                                    name="<?=$member_idx ? "" : "re_password"?>" id="re_password" class="width_30"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
										if($title_count == 4) {
									?>
                                <input value="<?= $title ?>" type="text" name="title_input"
                                    class="input_others en_check" maxlength="60">
                                <?php
										} else {
									?>
                                <input type="text" name="title_input" class="input_others en_check input_others_on"
                                    maxlength="60">
                                <?php
										}
									?>
                            ...
                            <td>
                                ...
                                <?php
											if($degree_count == 3) {
										?>
                                <input value="<?= $degree ?>" type="text" name="degree_input"
                                    class="input_others en_check" maxlength="60">
                                <?php
											} else {
										?>
                                <input type="text" name="degree_input" class="input_others en_check input_others_on"
                                    maxlength="60">
                                <?php
											}
										?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
									...
									?>
                                <input value="<?= $category ?>" type="text" name="category_input"
                                    class="input_others en_check" maxlength="60">
                                <?php
										} else {
									?>
                                <input type="text" name="category_input" class="input_others en_check input_others_on"
                                    maxlength="60">
                                <?php
										}
									?>
                        ...
                        <tr>
                            <th>의사번호</th>
                            <td>
                                <input <?=$licence_number != "Not applicable" ? "" : "checked"; ?> type="checkbox"
                                    class="checkbox input not_checkbox" id="licence_number" name="licence_number2"
                                    value="Not applicable"><label for="licence_number">Not applicable</label>
                                <input <?=$licence_number != "Not applicable" ? "" : "disabled"; ?>
                                    name="licence_number" type="text"
                                    value="<?=$licence_number != "Not applicable" ? $licence_number : ""; ?>"
                                    class="kor_check">
                            </td>
                            <th>전문의번호</th>
                            <td>
                                <input <?=$specialty_number != "Not applicable" ? "" : "checked"; ?> type="checkbox"
                                    class="checkbox input not_checkbox" id="specialty_number" name="specialty_number2"
                                    value="Not applicable"><label for="specialty_number">Not applicable</label>
                                <input <?=$specialty_number != "Not applicable" ? "" : "disabled"; ?>
                                    name="specialty_number" type="text"
                                    value="<?=$specialty_number != "Not applicable" ? $specialty_number : ""; ?>"
                                    class="kor_check">
                            </td>
                        </tr>
                        <tr>
                            <th>영양사번호</th>
                            <td>
                                <input <?=$nutritionist_number != "Not applicable" ? "" : "checked"; ?> type="checkbox"
                                    class="checkbox input not_checkbox" id="nutritionist_number"
                                    name="nutritionist_number2" value="Not applicable"><label
                                    for="nutritionist_number">Not applicable</label>
                                <input <?=$nutritionist_number != "Not applicable" ? "" : "disabled"; ?>
                                    name="nutritionist_number" type="text"
                                    value="<?=$nutritionist_number != "Not applicable" ? $nutritionist_number : ""; ?>"
                                    class="kor_check">
                            </td>
                            <th>Date of Birth</th>
                            <td><input maxlength="10" name="date_of_birth" type="text" class="datepicker_input"
                                    id="datepicker" value="<?= $date_of_birth; ?>"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
								...
								?>
                                <input <?= !empty($member_idx) ? $food_radio_value[0] : "checked";?> value="None"
                                    type="radio" id="none" class="radio" name="food">
                                ...
                                <input <?= !empty($member_idx) ? $food_radio_value[3] : "";?> value="Others"
                                    type="radio" id="Others" class="radio other_radio" name="food">
                                <label for="Others">
                                    Others
                                    <?php
											if(!empty($member_idx)) {
...
function inputCheck() {
    ...
    $.each(formData, function(key, value) {
        ...
        if (ov == "" || ov == "undefined" || ov == null) {
            if (ok == "email" || ok == "password" || ok == "re_password" || ok == "first_name" || ok ==
                "last_name" || ok == "phone") {
                if (ok == "email") {
