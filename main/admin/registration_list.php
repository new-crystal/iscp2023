...
$html .= '<th style="background-color:#FFE699; border-style: solid; border-width:thin;">회원 여부</th>';
...
$html .= '<th style="background-color:#F2F2F2; border-style: solid; border-width:thin;">ISCP 2023 개최정보를 어떻게 알게 되셨나요?</th>';
