            ...
            <div class="section section1">
                ...
                <div class="input_area">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <label for="preferred_presentation_type_0">Oral or Poster</label> -->
                                            <input checked type="radio" class="radio" id="preferred_presentation_type_1" name="preferred_presentation_type" value="1" <?= ($detail['preferred_presentation_type'] == "1" ? "checked" : "") ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td class="half">
                                            <select name="topic1" id=""><?= get_topic1_option_text($topic1_list, $detail['topic']) ?></select>
                                            <!-- <select name="topic2"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="rightT red_txt">Title is limited to 25 words. (All title words : <span class="red_txt" name="word_limit_title">0</span> / 25)</p>
                                            <!-- <textarea name="" id="" cols="30" rows="10"></textarea> -->
                                            <? //=editor_html("title", htmlspecialchars_decode($detail['title'], ENT_QUOTES));
                                            ?>
                                            <textarea id="title" name="title" class="smarteditor2" maxlength="65536" style="width:100%;height:100px"><?= htmlspecialchars_decode($detail['title'], ENT_QUOTES) ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <textarea id="objectives" name="objectives" class="smarteditor2" maxlength="65536" style="width:100%;height:100px"><?= htmlspecialchars_decode($detail['objectives'], ENT_QUOTES) ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <textarea id="methods" name="methods" class="smarteditor2" maxlength="65536" style="width:100%;height:100px"><?= htmlspecialchars_decode($detail['methods'], ENT_QUOTES) ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <textarea id="results" name="results" class="smarteditor2" maxlength="65536" style="width:100%;height:100px"><?= htmlspecialchars_decode($detail['results'], ENT_QUOTES) ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <textarea id="conclusions" name="conclusions" class="smarteditor2" maxlength="65536" style="width:100%;height:100px"><?= htmlspecialchars_decode($detail['conclusions'], ENT_QUOTES) ?></textarea>
                                        </td>
                                    </tr>
                                    <tr style="display: none;">
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <textarea id="keywords" name="keywords" class="smarteditor2" maxlength="65536" style="width:100%;height:100px"><?= htmlspecialchars_decode($detail['keywords'], ENT_QUOTES) ?></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                            ...
                                            <td>
                                                <div class="citation_box">
                                                    <div class="file_input file_submission">
                                                        <label class='label' data-js-label><?= $file_name != "" ? $file_name : $locale("select_file") ?></label>
                                                        <input type="file" name="abstract_file<?= $i ?>" class="abstract_file check_word_limit" accept=".jpeg, .jpg, .gif, .bmp, .png" data-idx="<?= $idx ?>">
                                                        <span class="btn dark_gray_btn">File Find</span>
                                                        <span class="btn dark_gray_btn delete_file">Delete</span>
                                                    </div>
                                                    <div>
                                                        <input type="text" placeholder="Image <?= $i ?> caption" name="abstract_file_caption<?= $i ?>" class="en_num_keyup" value="<?= $caption ?>">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <tr style="display:none">
                                        <td colspan="2">
                                            <p>Have you submitted this abstract or an abstract of a similar topic at another
                                                conference?</p>
                                            <input type="radio" class="radio" name="similar_yn" id="similar_yn_y" value="Y" <?= $detail['similar_yn'] == "Y" ? "checked" : "" ?>>
                                            <label for="similar_yn_y">yes</label>
                                            <input checked type="radio" class="radio" name="similar_yn" id="similar_yn_n" value="N" <?= $detail['similar_yn'] == "N" ? "checked" : "" ?>>
                                    ...
                                    <tr style="display:none">
                                        <td colspan="2">
                                            <p>This research is supported by the grant of Korean Society of Lipid and
                                                Atherosclerosis.</p>
                                            <input checkd type="radio" class="radio" name="support_yn" id="support_yn_y" value="Y" <?= $detail['support_yn'] == "Y" ? "checked" : "" ?>>
                                            <label for="support_yn_y">yes</label>
                                            <input type="radio" class="radio" name="support_yn" id="support_yn_n" value="N" <?= $detail['support_yn'] == "N" ? "checked" : "" ?>>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            ?>
                                            <input type="checkbox" class="checkbox check_age" id="travel_grants_yn" name="travel_grants_yn" <?= $travel_grants_y_flag ? "checked" : "" ?>>
                                    ...
                                    <tr name="check_age" style="<?= ($travel_grants_y_flag || $awards_y_flag || $investigator_grants_y_flag) ? "" : "display: none" ?>;">
                                        <td colspan="2">
                                            ...
                                            <div class="citation_box">
                                                <div class="file_input file_submission">
                                                    ...
                                                    ?>
                                                    <label class='label' data-js-label><?= $file_name != "" ? $file_name : $locale("select_file") ?></label>
                                                    <input type="file" name="prove_age_file" class="abstract_file" accept=".jpeg, .jpg, .gif, .bmp, .png" data-idx="<?= $idx ?>">
                                                    <span class="btn dark_gray_btn">File Find</span>
                                                    <span class="btn dark_gray_btn delete_file">Delete</span>
                                                </div>
                                            </div>
                    ...
                    <div class="pager_btn_wrap">
                        ...
                        <button type="button" class="btn" onclick="javascript:location.href='./abstract_submission.php?idx=<?= $submission_idx ?>';">Previous</button>
