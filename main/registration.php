                        ...
                        <table class="table table_responsive left_border_table">
                            ...
                            <tbody class="centerT">
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" class="radio" id="c_type2-1" name="c_type1" value="<?= $r_during_yn == 'N' ? "200" : "200"; ?>" onclick="return(false);" <?= $usd_80_check; ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" class="radio" id="c_type2-2" name="c_type1" value="<?= $r_during_yn == 'N' ? "100" : "100"; ?>" onclick="return(false);" <?= $usd_40_check; ?>>
                        ...
                        <table class="table table_responsive">
                            ...
                            <tbody class="centerT">
                                <tr>
                                    <td>전문의, 교수</td>
                                    <td>
                                        <input type="radio" class="radio" id="c_type1-1" name="c_type1" value="<?= $r_during_yn == 'N' ? "50000" : "50000"; ?>" onclick="return(false);" <?= $krw_8_check; ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" class="radio" id="c_type2" name="c_type1" value="<?= $r_during_yn == 'N' ? "10000" : "10000"; ?>" onclick="return(false);" <?= $krw_4_check; ?>>
