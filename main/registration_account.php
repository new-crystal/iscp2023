...
?>
		...
		<div class="inner bottom_short">
			<div class="account_div">
				...
				<ul class="text_indent">
					<li>등록비 입금 시 등록자 명으로 입금해주시기 바랍니다.<br/>다른 이름 혹은 소속기관명으로 입금하실 경우 반드시 사무국 이메일(secretariat@icola2022.org)로 연락 바랍니다</li>
				</ul>
					...
					<table class="table"><!--detail_table-->
						...
						<tbody>
							...
							<tr>
								...
								<td>100-033-623706</td>
							</tr>
							<tr>
								<th class="leftT">예금주</th>
								<td>한국지질동맥경화학회(The Korean Society of Lipid and Atherosclerosis)</td>
							</tr>
							<tr>
								<th class="leftT red_txt bold">총 등록비</th>
								<td class="red_txt bold"><?=(($nation_no == 25) ? number_format($price_eyes)." ".$price_name : $price_name." ".number_format($price_eyes))?></td>
							</tr>
						</tbody>
					</table>
				</div>
	...
	<div class="popup cancel_pop">
		...
		<div class="pop_contents">
			...
			<p class="pre">등록비 환불은 대회 종료 후 이루어지며, 등록 취소 시 반드시 이메일(secretariat@icola2022.org)을 통하여 취소 내용을 사무국에 접수해주시기 바랍니다.</p>
			<div class="table_wrap c_table_wrap2" >
				<table class="c_table2">
					...
					<tbody>
						...
						<tr class="tr_center">
							<td>2022년 8월 7일부터 8월 26일까지 등록 취소 시</td>
							<td>50% 환불</td>
						</tr>
						<tr class="tr_center">
		...
		<div class="inner bottom_short">
			<div class="account_div details">
				...
				<ul class="text_indent">
					...
					<li>• Please send a copy of the wire transfer slip to the secretariat by e-mail(secretariat@icola2022.org) after writing the registrant’s name on the bank remittance receipt.</li>
					<li>• Appropriate payment should be completed within the right period of registration.<br>If you pay after the registration period, you will need to pay the corresponding additional fees.</li>
				</ul>
				<div class="table_wrap form_types">
					<table class="table"><!--detail_table-->
						<colgroup>
						...
						<tbody>
							...
							<tr>
								...
								<td>180-005-911078</td>
							</tr>
							<tr>
								<th><?=$locale("payment_account_holder_tit")?></th>
								<td>The Korean Society of Lipid and Atherosclerosis</td>
							</tr>
							<tr>
								<th>Swift Code</th>
								<td>SHBKKRSE</td>
							...
							<tr>
								<th>Bank Address</th>
								<td>Mapo ACRO TOWER 2nd 68 Mapo-Daero Mapo-gu Seoul</td>
							</tr>
							<tr>
								<th class="red_txt bold">Total registration fee</th>
								<td class="red_txt bold"><?=(($nation_no == 25) ? $price_name." ".number_format($price_eyes) : $price_name." ".number_format($price_eyes))?></td>
							</tr>
						</tbody>
					</table>
				</div>
