    ...
    <div class="inner bottom_short">
        <div class="input_area">
                ...
                <div class="table_wrap input_table">
                    <table>
                        ...
                        <tbody>
                            <!--
							<tr>
								<th><span class="red_txt">*</span>Attendance type<?= ($langage == "kor") ? "<br>(���� ����)" : ""; ?></th>
								<td>
							...
							<tr>
								<th><span class="red_txt">*</span><?= $locale("registration_type") ?><?= ($langage == "kor") ? "<br>(���� ����)" : ""; ?></th>
								<td>
									<div class="radio_wrap">
										<ul class="flex">
											<li>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" class="radio" id="c_type1-1" name="c_type1"
                                    ...
                                    <?= $krw_8_check; ?>>
                                <label for="c_type1-1"><?= $r_during_yn == 'N' ? "80,000��" : "50,000��"; ?></label>
                            </td>
                            <!-- <td>
                                        ...
                                        <label for="c_type1-2"><?= $r_during_yn == 'N' ? "100,000��" : "120,000��"; ?></label>
                                    </td> -->
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="radio" class="radio" id="c_type2" name="c_type1"
                                    ...
                                    <?= $krw_4_check; ?>>
                                <label for="c_type2"><?= $r_during_yn == 'N' ? "50,000��" : "10,000��"; ?></label>
                            </td>
                        </tr>
                        <!-- <tr> -->
							...
							<tr>
								...
								<td>
									<div class="file_submission input_2btn promote_code">
										...
										<!-- <button type="button" class="btn gray_btn">�ڵ�����</button>
									...
									<div class="radio_wrap">
										<ul class="flex">
											<li>
												...
												<label for="pay_type1"><?= ($langage == "en") ? "Credit Card" : "ī�� ����"; ?></label>
											</li>
											<li>
												<input type="radio" class="radio required" id="pay_type2" name="payment_methods" value="1">
												<label for="pay_type2"><?= ($langage == "en") ? "Bank Transfer" : "���� ��ü"; ?></label>
											</li>
										</ul>
									</div>
								</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" class="radio required" id="others_type11"
                                        ...
                                        <?= $welcome_reception_yn != "N" ? "checked" : ""; ?>>
                                    <label for="others_type11">Yes</label>
                                    <?php
                                        if (empty($registration_idx)) {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type12"
                                        name="welcome_reception" value="N" checked>
                                    <?php
                                        } else {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type12"
                                        name="welcome_reception" value="N"
                                        <?= $welcome_reception_yn != "Y" ? "checked" : ""; ?>>
                                    <?php
                                        }
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        if (empty($registration_idx)) {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type2" name="day1_luncheon"
                                        value="N" checked>
                                    <?php
                                        } else {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type2" name="day1_luncheon"
                                        value="N" <?= $day1_luncheon_yn != "Y" ? "checked" : ""; ?>>
                                    <?php
                                        }
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        if (empty($registration_idx)) {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type4" name="day2_breakfast"
                                        value="N" checked>
                                    <?php
                                        } else {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type4" name="day2_breakfast"
                                        value="N" <?= $day2_breakfast_yn != "Y" ? "checked" : ""; ?>>
                                    <?php
                                        }
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        if (empty($registration_idx)) {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type6" name="day2_luncheon"
                                        value="N" checked>
                                    <?php
                                        } else {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type6" name="day2_luncheon"
                                        value="N" <?= $day2_luncheon_yn != "Y" ? "checked" : ""; ?>>
                                    <?php
                                        }
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        if (empty($registration_idx)) {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type8" name="day3_breakfast"
                                        value="N" checked>
                                    <?php
                                        } else {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type8" name="day3_breakfast"
                                        value="N" <?= $day3_breakfast_yn != "Y" ? "checked" : ""; ?>>
                                    <?php
                                        }
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        if (empty($registration_idx)) {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type10" name="day3_luncheon"
                                        value="N" checked>
                                    <?php
                                        } else {
                                        ?>
                                    <input type="radio" class="radio required" id="others_type10" name="day3_luncheon"
                                        value="N" <?= $day3_luncheon_yn != "Y" ? "checked" : ""; ?>>
                                    <?php
                                        }
                                        ?>
            ...
            <?php
                ...
                ?>
            <form name="registration_form" onsubmit="return false" class="form_types">
                <div class="circle_title">ISCP 2023 ���������� ��� �˰� �Ǽ̳���?</div>
                <div class="table_wrap">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <label for="register_path1">���ѽ������๰ġ����ȸ Ȩ������ �Ǵ� ȫ������</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <label for="register_path2">ISCP ȫ������ �Ǵ� �Խ��� ����</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <label for="register_path3">��û����/�������� ��û����</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <label for="register_path4">���� ISCP�� ������ ������ ����</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input value="4" type="checkbox" class="checkbox check_age" id="register_path5"
                                        name="register_path" <?= in_array(4, $register_path_arr) ? "checked" : ""; ?>>
                                    <label for="register_path5">����ȸ�� �Ұ�</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input value="5" type="checkbox" class="checkbox check_age" id="register_path6"
                                        name="register_path" <?= in_array(5, $register_path_arr) ? "checked" : ""; ?>>
                                    <label for="register_path6">������ ����</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input value="6" type="checkbox" class="checkbox check_age" id="register_path7"
                                        name="register_path" <?= in_array(6, $register_path_arr) ? "checked" : ""; ?>>
                                    <label for="register_path7">���ͳ� �˻�</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input value="7" type="checkbox" class="checkbox check_age" id="register_path8"
                                        name="register_path" <?= in_array(7, $register_path_arr) ? "checked" : ""; ?>>
                                    <label for="register_path8">
                                        ��Ÿ
                                        <input
                                            <?= in_array(7, $register_path_arr) ? "style='display:inline-block;'" : ""; ?>
                                            name="register_path_others" type="text" maxlength="60"
                                            class="others ko_keyup" value="<?= $register_path_others; ?>">
                                    </label>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2">
                                    <input value="0" type="checkbox" class="checkbox check_age" id="register_path1"
                                        name="register_path" <?= in_array(0, $register_path_arr) ? "checked" : ""; ?>>
                                    <label for="register_path1">Website or newletter of KSCP</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                ...
                                <td colspan="2">
                                    ...
                                    <label for="register_path8">
                                        ...
                                        <input
                                            <?= in_array(7, $register_path_arr) ? "style='display:inline-block;'" : ""; ?>
                                            name="register_path_others" type="text" maxlength="60"
                                            class="others en_keyup" value="<?= $register_path_others; ?>">
                                    </label>
                                </td>
                            </tr>
                        </tbody>
            ...
            <?php
                ...
                ?>
            <div>
                <input type="checkbox" class="checkbox" id="invitation" name="invitation"
                    <?= $invitation_yn == "Y" ? "checked" : ""; ?>>
                        ...
                        <table class="table detail_table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="name_td clearfix">
                                        <div class="max_normal">
                                            ...
                                            <input class="en_keyup" name="invitation_first_name" type="text"
                                                placeholder="First Name" value="<?= $invitation_first_name; ?>">
                                        </div>
                                        <div class="max_normal">
                                            <!-- <input type="text"placeholder="Last(Family) Name" disabled> -->
                                            <input class="en_keyup" name="invitation_last_name" type="text"
                                                placeholder="Last Name" value="<?= $invitation_last_name; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <select class="required" name="invitation_nation_no"
                                                id="invitation_nation_no">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <input class="en_num_keyup" type="text" id="address_input"
                                                name="invitation_address" value="<?= $invitation_address; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <input class="en_num_keyup" type="text" placeholder="Passport Number"
                                                name="invitation_passport" value="<?= $invitation_passport; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <input type="text" placeholder="dd.mm.yyyy" id="datepicker"
                                                name="invitation_date_of_birth"
                                                value="<?= $invitation_date_of_birth; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <input type="text" placeholder="dd.mm.yyyy" id="datepicker"
                                                name="invitation_date_of_issue"
                                                value="<?= $invitation_date_of_issue; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <input type="text" placeholder="dd.mm.yyyy" id="datepicker"
                                                name="invitation_date_of_expiry"
                                                value="<?= $invitation_date_of_expiry; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="max_normal">
                                            <input class="en_num_keyup" type="text" placeholder="Length of Visit"
                                                name="invitation_length_of_visit"
                                                value="<?= $invitation_length_of_visit; ?>">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <ul class="sign_list">
                            <li>
                                ...
                                <div class="half_form clearfix">
                                    <input class="en_keyup" name="mo_invitation_first_name" type="text"
                                        placeholder="First Name" value="<?= $invitation_first_name; ?>" />
                                    <input class="en_keyup" name="mo_invitation_last_name" type="text"
                                        placeholder="Last Name" value="<?= $invitation_last_name; ?>" />
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    <select class="required" name="mo_invitation_nation_no"
                                        id="mo_invitation_nation_no">
                                        <option value="" selected hidden>Choose</option>
                                        <?php
                                            foreach ($nation_list as $list) {
                                                $nation = $language == "en" ? $list["nation_en"] : $list["nation_ko"];
                            ...
                            <li>
                                ...
                                <div>
                                    <input name="mo_invitation_address" class="en_keyup" type="text" id="address_input"
                                        placeholder="Please enter a default address."
                                        value="<?= $invitation_address; ?>">
                                </div>
                            </li>
                            <li>
                                <p class="label">Passport Number</p>
                                <div><input name="mo_invitation_passport" class="num_keyup" type="text"
                                        placeholder="Passport Number" value="<?= $invitation_passport; ?>" /></div>
                            </li>
                            <li>
                                <p class="label">Date of Birth</p>
                                <div><input name="mo_invitation_date_of_birth" type="text" placeholder="dd.mm.yyyy"
                                        id="datepicker" value="<?= $invitation_date_of_birth; ?>" /></div>
                            </li>
                            <li>
                                <p class="label">Date of Issue</p>
                                <div><input name="mo_invitation_date_of_issue" type="text" placeholder="dd.mm.yyyy"
                                        id="datepicker" value="<?= $invitation_date_of_issue; ?>" /></div>
                            </li>
                            <li>
                                <p class="label">Date of Expiry</p>
                                <div><input name="mo_invitation_date_of_expiry" type="text" placeholder="dd.mm.yyyy"
                                        id="datepicker" value="<?= $invitation_date_of_expiry; ?>" /></div>
                            </li>
                            <li>
                                <p class="label">Length of Visit</p>
                                <div><input name="mo_invitation_length_of_visit" class="en_num_keyup" type="text"
                                        value="<?= $invitation_length_of_visit; ?>" /></div>
                            </li>
                        </ul>
...
//				document.getElementById("address_input").value = data.address; // �ּ� �ֱ�
//				document.getElementById("address_detail").focus(); //���Է� ��Ŀ��
//			}
//		}).open();
//	});
//}
