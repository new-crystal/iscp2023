...
<?php
    ...
    if (!empty($registration_idx)) {
        ...
        //¼öÁ¤ÀÏ ¶© ·¹Áö½ºÆ®·¹ÀÌ¼Ç¿¡ µî·ÏµÇ¾î ÀÖ´Â È¸¿ø Á¤º¸
...
?>
    ...
    <section class="container submit_application register">
        ...
        <div class="inner bottom_short">
            <div class="input_area">
                    ...
                    <div class="table_wrap input_table">
                        <table>
                            ...
                            <tbody>
                                <!--
							<tr>
								<th><span class="red_txt">*</span>Attendance type<?= ($langage == "kor") ? "<br>(Âü¼® ÇüÅÂ)" : ""; ?></th>
								<td>
							...
							<tr>
								<th><span class="red_txt">*</span><?= $locale("registration_type") ?><?= ($langage == "kor") ? "<br>(Âü¼® ÇüÅÂ)" : ""; ?></th>
								<td>
									<div class="radio_wrap">
										<ul class="flex">
											<li>
                ...
                ?>
                    <!-- content3 -->
                    <div class="circle_title">µî·Ïºñ</div>
                    <div class="table_wrap">
                            ...
                            <tbody class="centerT">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label for="c_type1-1"><?= $r_during_yn == 'N' ? "80,000¿ø" : "50,000¿ø"; ?></label>
                                    </td>
                                    <!-- <td>
                                        ...
                                        <label for="c_type1-2"><?= $r_during_yn == 'N' ? "100,000¿ø" : "120,000¿ø"; ?></label>
                                    </td> -->
                                </tr>
                                <tr>
                                    <td>
                                        ÀüÀÓÀÇ, Àü°øÀÇ, ±ºÀÇ°ü/°øº¸ÀÇ,<br />
                                        ¿¬±¸¿ø, ÇÐ»ý, °£È£»ç,<br />
                                        ¿µ¾ç»ç, ¾à»ç, ±â¾÷È¸¿ø, ±âÅ¸
                                    </td>
                                    <td>
                                        <input type="radio" class="radio" id="c_type2" name="c_type1" value="<?= $r_during_yn == 'N' ? "50000" : "60000"; ?>" onclick="return(false);" <?= $krw_4_check; ?>>
                                        <label for="c_type2"><?= $r_during_yn == 'N' ? "50,000¿ø" : "10,000¿ø"; ?></label>
                                    </td>
                                </tr>
                                <!-- <tr> -->
							...
							<tr>
								...
								<td>
									<div class="file_submission input_2btn promote_code">
										...
										<!-- <button type="button" class="btn gray_btn">ÄÚµåÀÎÁõ</button>
									...
									<div class="radio_wrap">
										<ul class="flex">
											<li>
												...
												<label for="pay_type1"><?= ($langage == "en") ? "Credit Card" : "Ä«µå °áÁ¦"; ?></label>
											</li>
											<li>
												<input type="radio" class="radio required" id="pay_type2" name="payment_methods" value="1">
												<label for="pay_type2"><?= ($langage == "en") ? "Bank Transfer" : "°èÁÂ ÀÌÃ¼"; ?></label>
											</li>
										</ul>
									</div>
								</td>
                ...
                ?>
                    <form name="registration_form" onsubmit="return false" class="form_types">
                        <div class="circle_title">ISCP 2023 °³ÃÖÁ¤º¸¸¦ ¾î¶»°Ô ¾Ë°Ô µÇ¼Ì³ª¿ä?</div>
                        <div class="table_wrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path1">´ëÇÑ½ÉÇ÷°ü¾à¹°Ä¡·áÇÐÈ¸ È¨ÆäÀÌÁö ¶Ç´Â È«º¸¸ÞÀÏ</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path2">ISCP È«º¸¸ÞÀÏ ¶Ç´Â °Ô½ÃÆÇ ±¤°í</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path3">ÃÊÃ»¿¬ÀÚ/ÁÂÀåÀ¸·Î ÃÊÃ»¹ÞÀ½</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path4">ÀÌÀü ISCP¿¡ Âü¼®ÇÑ °æÇèÀÌ ÀÖÀ½</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path5">Á¦¾àÈ¸»ç ¼Ò°³</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path6">ÁöÀÎÀ» ÅëÇØ</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <label for="register_path7">ÀÎÅÍ³Ý °Ë»ö</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
    ...
    <script>
        ...
        //		//Ä«Ä«¿À Áöµµ ¹ß»ý
        //		new daum.Postcode({
        //			oncomplete: function(data) { //¼±ÅÃ½Ã ÀÔ·Â°ª ¼¼ÆÃ
        //				document.getElementById("address_input").value = data.address; // ÁÖ¼Ò ³Ö±â
        //				document.getElementById("address_detail").focus(); //»ó¼¼ÀÔ·Â Æ÷Ä¿½Ì
        //			}
        //		}).open();
        //	});
        //}
