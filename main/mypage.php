				...
				<div class="pc_only">
					...
					?>
						...
						?>
							...
							<td>
								<div class="max_normal">
									<input <?=$user_info["licence_number"] != "Not applicable" ? "" : "checked"; ?> type="checkbox" class="checkbox input not_checkbox" id="licence_number" name="licence_number2" value="Not applicable"><label for="licence_number">Not applicable</label>
						...
						?>
							...
							<td>
								<div class="max_normal">
									<input <?= $user_info["specialty_number"] != "Not applicable" ? "" : "checked"; ?> type="checkbox" class="checkbox input not_checkbox" id="specialty_number" name="specialty_number2" value="Not applicable"><label for="specialty_number">Not applicable</label>
				...
				<div class="mb_only">
					<ul class="sign_list">
						...
						?>
							...
							<div>
								<input <?=$user_info["licence_number"] != "Not applicable" ? "" : "checked"; ?> type="checkbox" class="checkbox input not_checkbox" id="mo_licence_number" name="mo_licence_number2" value="Not applicable"><label for="mo_licence_number">Not applicable</label>
						...
						?>
							...
							<div>
								<input <?=$user_info["specialty_number"] != "Not applicable" ? "" : "checked"; ?> type="checkbox" class="checkbox input not_checkbox" id="mo_specialty_number" name="mo_specialty_number2" value="Not applicable"><label for="mo_specialty_number">Not applicable</label>
