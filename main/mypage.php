                ...
                <div class="pc_only">
                    <table class="table detail_table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="max_normal">
                                    <input class="passwords" name="password" type="password" id="password"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="max_normal">
                                    <input class="passwords" name="password2" type="password" id="re_password"
					...
					?>
                        ...
                        <td>
                            <div class="max_normal">
                                <input name="name_kor" type="text" value="<?=$user_info["name_kor"]?>"
                                    class="kor_check">
					...
					?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input value="<?= $tel_nation_tel; ?>" class="tel_number tel_phone"
                                    name="tel_nation_tel" type="text" maxlength="60">
                                <input value="<?= $tel_nation_tel2; ?>" class="tel_numbers tel_phone" name="telephone1"
                                    type="text" maxlength="60">
                                <input value="<?= $tel_phone; ?>" class="tel_numbers tel_phone2" name="telephone2"
                                    type="text" maxlength="60">
                                <!-- <div> -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="max_normal">
									...
									?>
                                    <input value="<?= $user_info["category"] ?>" type="text" name="category_input"
                            ...
                            <td class="clearfix">
                                <div class="max_normal responsive_float clearfix">
                                    ...
                                    <?php
										if($title_count == 4) {
									?>
                                    <input value="<?= $user_info["title"] ?>" type="text" name="title_input"
                                        class="input_others en_check" maxlength="60">
                                    <?php
										} else {
									?>
                            ...
                            <td class="clearfix">
                                <div class="max_normal responsive_float clearfix">
                                    ...
                                    <?php
										if($degree_count == 3) {
									?>
                                    <input value="<?= $user_info["degree"] ?>" type="text" name="degree_input"
                                        class="input_others en_check" maxlength="60">
                                    <?php
										} else {
									?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="max_normal">
                                    <input maxlength="10" name="date_of_birth" type="text" class="datepicker_input"
