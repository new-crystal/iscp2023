...
$sql_during = "SELECT
						IF(NOW() BETWEEN '2022-08-18 17:00:00' AND '2023-09-06 18:00:00', 'Y', 'N') AS yn
					FROM info_event";
    ...
    <section class="container submit_application register">
        ...
        <div class="inner bottom_short">
            ...
            <div class="btn_wrap pager_btn_wrap">
                <button type="button" class="btn green_btn" onClick="javascript:location.href='./registration2_test.php'">Register</button>
<!--                <button type="button" class="btn green_btn">Next</button>-->
    ...
    <script src="./js/script/client/registration_test.js?v=0.2"></script>
