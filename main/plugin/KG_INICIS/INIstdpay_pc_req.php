...
<head>
    ...
    <link rel="stylesheet" href="./css/pg/pg_style.css">
    <link rel="stylesheet" href="/css/pg/pg_bootstrap.min.css">
        ...
        <div class="card">
            ...
            <form name="" id="SendPayForm_id" method="post" class="mt-5">
                <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
                    ...
                    <input type="hidden" name="returnUrl" value="https://iscp2023.org/main/INIstdpay_pc_return.php">
                    <input type="hidden" name="closeUrl" value="https://iscp2023.org/main/INIstdpay_close.php">
