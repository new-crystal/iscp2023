...
jindo.$Jindo = function () {
  ...
  this.version = "1.5.2-SMART_EDITOR";
};
jindo.$ = function (l) {
  var h = [],
    o = arguments,
...
jindo._createEle = function (g, f, a, e) {
  ...
  switch (g) {
    ...
    case "col":
      d.innerHTML =
        "<table><" + g + ' class="' + c + '">' + f + "</" + g + "></table>";
      break;
    case "tr":
      d.innerHTML =
        '<table><tbody><tr class="' + c + '">' + f + "</tr></tbody></table>";
      break;
    default:
    ...
    var superFunc = function (m, superClass, func) {
      if (m != "constructor" && func.toString().indexOf("$super") > -1) {
        ...
        var funcStr = func
          .toString()
          .replace(/function[^{]*{/, "")
          .replace(/(\w|\.?)(this\.\$super|this)/g, function (m, m2, m3) {
            if (!m2) {
              return m3 + ".$super";
            }
            return m;
        ...
        func = superClass[m] = eval(
          "false||function(" + funcArg.join(",") + "){" + funcStr + "}"
        );
      }
      return function () {
        var f = this.$this[m];
...
jindo.$$ = jindo.cssquery = (function () {
  ...
  var getUID4HTML = function (oEl) {
    var nUID = safeHTML
      ? oEl._cssquery_UID && oEl._cssquery_UID[0]
      : oEl._cssquery_UID;
      ...
      if (window.getComputedStyle) {
        return (
          oDocument_dontShrink.defaultView
            .getComputedStyle(oEl, null)
            .getPropertyValue(sKey.replace(/([A-Z])/g, "-$1").toLowerCase()) ||
          oEl.style[sKey]
        );
      }
    }
  ...
  var getNodeIndex = function (oEl) {
    ...
    if (nIndex == 0) {
      for (
        var oSib = (oEl.parentNode || oEl._IE5_parentNode).firstChild;
        oSib;
  ...
  var oPseudoes_dontShrink = {
    ...
    "only-child": function (oEl, sOption) {
      var nChild = 0;
      for (
        var oChild = (oEl.parentNode || oEl._IE5_parentNode).firstChild;
        oChild;
  ...
  var getExpression = function (sBody) {
    ...
    var sBody = sBody.replace(
      ...
      function (_1, sType, _2, sOption) {
        switch (sType) {
          ...
          case "last-of-type":
            sType =
              sType == "first-of-type" ? "nth-of-type" : "nth-last-of-type";
            sOption = 1;
          case "nth-of-type":
    ...
    oRet.quotTAG = sTagName
      ? wrapQuot(bXMLDocument ? sTagName : sTagName.toUpperCase())
      : "";
  ...
  var compileParts = function (aParts) {
    ...
    for (var i = aParts.length - 1, oPart; (oPart = aParts[i]); i--) {
      ...
      var sReturn =
        "if (bStop) {" + (i == 0 ? "return aRet;" : "return;") + "}";
      ...
      if (oExpr.nth) {
        sPush =
          ...
          oExpr.nth[1] +
          ',"' +
          (oExpr.nth[2] == "nth-of-type" ? "previousSibling" : "nextSibling") +
          '")) {' +
          sPush +
          "}";
      }
  ...
  var old_cssquery = function (sQuery, oParent, oOptions) {
    ...
    for (var r = 0, rp = debugOption.repeat; r < rp; r++) {
      aRet = (function (sQuery, oParent, oOptions) {
        ...
        oDocument_dontShrink =
          oParent.ownerDocument || oParent.document || oParent;
        if (
          ...
          oDocument_dontShrink.firstChild = oDocument_dontShrink.getElementsByTagName(
            "html"
          )[0];
        ...
        for (var i = 0; i < nLen; i++) {
          ...
          var sResultCacheKey =
            sSingleQuery + (oOptions.single ? "_single" : "");
      ...
      try {
        if (_isNonStandardQueryButNotException(sQuery)) {
          ...
          if (oParent.nodeType != 9) {
            ...
            sReviseQuery = _commaRevise(
              "#" + oParent.id + " " + sQuery,
              ", #" + oParent.id
            );
            oReviseParent =
              oParent.ownerDocument || oParent.document || document;
          }
...
jindo.$Agent.prototype.navigator = function () {
  ...
  b.edge = g("Edge", n);
  b.webkit = !b.edge && g("WebKit", n);
  b.opera = window.opera !== undefined || g("Opera", n) || g("OPR", n);
  b.ie = !b.opera && (g("MSIE", n) || g("Trident", n));
  b.chrome =
    (!b.edge && b.webkit && !b.opera && g("Chrome", n)) || g("CriOS", n);
  b.safari = !b.edge && b.webkit && !b.chrome && !b.opera && g("Apple", m);
  b.firefox = g("Firefox", n);
  b.mozilla =
    !b.edge && g("Gecko", n) && !b.safari && !b.chrome && !b.firefox && !b.ie;
  b.camino = g("Camino", m);
...
jindo.$A.prototype.splice = function (b, d) {
  var c = this._array.splice.apply(
    this._array,
    Array.prototype.slice.apply(arguments)
  );
  return jindo.$A(c);
  ...
  switch (d.type) {
    ...
    case "flash":
      ...
      this._request = new jindo.$Ajax.SWFRequest(
        jindo.$Fn(this.option, this).bind()
      );
      break;
    case "jsonp":
...
jindo.$Ajax.prototype._checkCORSUrl = function (a) {
  return (
    /^http/.test(a) &&
    !new RegExp("^http://" + window.location.host, "i").test(a)
  );
};
jindo.$Ajax.prototype._checkCORS = function (a, b) {
  this._bCORS = false;
  if (this._checkCORSUrl(a) && b === "xhr") {
...
jindo.$Ajax.prototype._onload = (function (a) {
  if (a) {
    return function () {
      var b = this._request.status;
      var c =
        (this._request.readyState == 4 && (b == 200 || b == 0)) ||
      ...
      if (this._request.readyState == 4 || this._bXDomainRequest) {
        try {
          if (
            ...
            if (!this._is_abort) {
              d = this._options.onload(jindo.$Ajax.Response(this._request));
            }
          }
        } finally {
          if (typeof this._oncompleted == "function") {
            this._oncompleted(c, d);
          }
...
jindo.$Ajax.prototype.request = function (c) {
  ...
  var l = d.type.toUpperCase();
  var g = d.method.toUpperCase();
  if (d.postBody && l == "XHR" && g != "GET") {
    if (typeof c == "string") {
      h = c;
    } else {
    ...
    if (typeof c == "undefined" || !c) {
      ...
      for (var f in c) {
        if (c.hasOwnProperty(f)) {
          ...
          if (r instanceof Array || r instanceof jindo.$A) {
            jindo.$A(r).forEach(function (t, a, v) {
              p[p.length] = f + "=" + encodeURIComponent(t);
            });
          } else {
            p[p.length] = f + "=" + encodeURIComponent(r);
          }
        }
      }
      h = p.join("&");
  ...
  m.open(g, b, !!d.async);
  if (d.withCredentials) {
    m.withCredentials = true;
  }
  if (this._bCORS && d.sendheader === false) {
    m.setRequestHeader = null;
  }
  if (
    l == "XHR" &&
    g == "GET" &&
    ...
    m.setRequestHeader &&
      m.setRequestHeader("If-Modified-Since", "Thu, 1 Jan 1970 00:00:00 GMT");
  }
  if (
    (l == "XHR" || l == "IFRAME" || (l == "FLASH" && d.sendheader)) &&
    m.setRequestHeader
  ) {
    ...
    m.setRequestHeader("charset", "utf-8");
    ...
    for (var o in this._headers) {
      if (this._headers.hasOwnProperty(o)) {
        if (typeof this._headers[o] == "function") {
          continue;
        }
        m.setRequestHeader(o, String(this._headers[o]));
      }
    }
  }
  ...
  if (
    ...
    if (this._loadFunc) {
      m.removeEventListener("load", this._loadFunc, false);
    }
    ...
    m.addEventListener("load", this._loadFunc, false);
    m.addEventListener("error", this._loadFunc, false);
  } else {
    if (typeof m.onload != "undefined") {
      m.onload = function (a) {
        if (m.readyState == 4 && !u._is_abort) {
          clearTimeout(e);
          e = undefined;
          u._onload(a);
        }
      };
      if (this._bXDomainRequest) {
        var s = m.onload;
        m.onload = function (a) {
          u._request.readyState = 4;
          u._request.status = 200;
          s(a);
        };
        m.onerror = function (a) {
          u._request.readyState = 4;
          u._request.status = 404;
          s(a);
        };
      }
    } else {
  ...
  if (d.timeout > 0) {
    ...
    e = setTimeout(function () {
      ...
      d.ontimeout(m);
      if (typeof u._oncompleted == "function") {
        u._oncompleted(false);
      }
    }, d.timeout * 1000);
    this._timer = e;
  }
  ...
  .$Class({
    ...
    _callback: function (a, b, d) {
      ...
      if (this.status == 200) {
        if (typeof b == "string") {
          try {
            this.responseText = this.option("decode")
...
jindo.$Ajax.FrameRequest = jindo
  .$Class({
    ...
    send: function (d) {
      ...
      var b = [];
      b.push(
        this._remote + "/ajax_remote_callback.html?method=" + this._method
      );
      var e = new Array();
...
jindo.$H.prototype.length = function () {
  ...
  for (var a in this._table) {
    if (this._table.hasOwnProperty(a)) {
      if (
        typeof Object.prototype[a] != "undefined" &&
    ...
    if (this._table.hasOwnProperty(b)) {
      if (typeof (d = this._table[b]) == "object" && d.constructor == Array) {
        for (i = 0; i < d.length; i++) {
          c[c.length] =
            encodeURIComponent(b) + "[]=" + encodeURIComponent(d[i] + "");
        }
      } else {
        c[c.length] =
          encodeURIComponent(b) + "=" + encodeURIComponent(this._table[b] + "");
      }
    }
  }
  return c.join("&");
...
jindo.$Json.fromXML = function (a) {
  var d = {};
  var m = /\s*<(\/?[\w:\-]+)((?:\s+[\w:\-]+\s*=\s*(?:"(?:\\"|[^"])*"|'(?:\\'|[^'])*'))*)\s*((?:\/>)|(?:><\/\1>|\s*))|\s*<!\[CDATA\[([\w\W]*?)\]\]>\s*|\s*>?([^<]*)/gi;
  var g = /^[0-9]+(?:\.[0-9]+)?$/;
  var h = {
    "&amp;": "&",
    "&nbsp;": " ",
...
jindo.$Json.prototype.compare = function (a) {
  return (
    ...
    jindo.$Json._oldToString(jindo.$Json(a).$value()).toString()
  );
};
...
jindo.$Cookie.prototype.set = function (e, f, d, a, b) {
  ...
  if (typeof d == "number") {
    c =
      ";expires=" +
      new Date(new Date().getTime() + d * 1000 * 60 * 60 * 24).toGMTString();
  }
  if (typeof a == "undefined") {
    a = "";
  }
  ...
  document.cookie =
    e + "=" + escape(f) + c + "; path=" + b + (a ? "; domain=" + a : "");
  return this;
};
...
jindo.$Event = function (b) {
  ...
  if (typeof b.relatedTarget != "undefined") {
    ...
    if (b.fromElement && b.toElement) {
      this.relatedElement =
        b[this.type == "mouseout" ? "toElement" : "fromElement"];
    }
  }
};
  ...
  if (c.currentStyle) {
    a = function (l, h) {
      try {
        ...
        throw new Error(
          (l.tagName || "document") + "는 css를 사용 할수 없습니다."
        );
      }
    };
  } else {
    if (window.getComputedStyle) {
        ...
        try {
          ...
          var f =
            ...
            m.defaultView
              ...
              .getPropertyValue(h.replace(/([A-Z])/g, "-$1").toLowerCase());
          if (h == "textDecoration") {
            f = f.replace(",", "");
          }
          return f;
      ...
      a = function (g, f) {
        try {
          ...
          throw new Error(
            (g.tagName || "document") + "는 css를 사용 할수 없습니다."
          );
        }
      };
    }
...
jindo.$Element.prototype._setCss = function (c, b, a) {
  if (
    "#top#left#right#bottom#".indexOf(b + "#") > 0 &&
  ...
  if (a) {
    jindo.$Element.prototype.html = function (h) {
      if (typeof h != "undefined" && arguments.length) {
        ...
        var g =
          "R" + new Date().getTime() + parseInt(Math.random() * 100000, 10);
...
jindo.$Element.prototype.fireEvent = function (c, b) {
  ...
  jindo.$Element.prototype.fireEvent =
    typeof this._element.dispatchEvent != "undefined" ? a : d;
...
jindo.$Fn._resizeEventBugInIE = function (c) {
  var a = document.documentMode >= 9 && document.documentMode < 11;
  if (!a) {
            ...
            if (n == "transitionend" || n == "transitionstart") {
              ...
              if (
                ...
                if (
                  ...
                  if (
                    typeof document.body.style.OAnimationName !== "undefined"
                  ) {
                    a = "o";
                  } else {
                    if (
                      typeof document.body.style.MsTransitionName !==
                      "undefined"
                    ) {
                      a = "ms";
                    }
...
jindo.$Fn.prototype.detach = function (f, c) {
  ...
  if (
    typeof d.removeEventListener != "undefined" &&
...
jindo.$S.prototype.trim = function () {
  if ("".trim) {
    ...
    jindo.$S.prototype.trim = function () {
      return jindo.$S(
        this._str.replace(/^(\s|　)+/g, "").replace(/(\s|　)+$/g, "")
      );
    };
  }
        ...
        if (" bcdoxX".indexOf(d) > 0) {
          ...
          h =
            d == "c"
              ...
              : e.toString({ b: 2, d: 10, o: 8, x: 16, X: 16 }[d]);
          if (" X".indexOf(d) > 0) {
            h = h.toUpperCase();
          }
        }
...
jindo.$Document = function (b) {
  ...
  this._docKey =
    this.renderingMode() == "Standards" ? "documentElement" : "body";
};
...
jindo.$Document.prototype.renderingMode = function () {
  ...
  if ("compatMode" in this._doc) {
    c =
      this._doc.compatMode == "CSS1Compat"
        ? "Standards"
        : d
        ? "Quirks"
        : "Almost";
...
jindo.$Template = function (d) {
  ...
  if (typeof d == "undefined") {
    ...
    if (
      (c = document.getElementById(d) || d) &&
      c.tagName &&
      (a = c.tagName.toUpperCase()) &&
      (a == "TEXTAREA" ||
        (a == "SCRIPT" && c.getAttribute("type") == "text/template"))
    ) {
...
jindo.$Template.prototype.process = function (data) {
  ...
  var cb = [
    function (m) {
      return m.substring(0, 1) == '"' || m.substring(0, 1) == "'" || m == "null"
        ? m
        : "d." + m;
    },
    function (m) {
...
jindo.$Date.prototype.format = function (c) {
  ...
  var b = this.name();
  var a = this;
  return (c || "").replace(/[a-z]/gi, function g(d) {
    ...
    switch (d) {
      ...
      case "z":
        f.z = Math.floor(
          (e.getTime() - new Date(e.getFullYear(), 0, 1).getTime()) /
            (3600 * 24 * 1000)
        );
        return f.z;
      case "m":
