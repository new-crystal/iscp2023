...
<?php
	...
	if($nation_no == 25) {
		$g_conf_site_cd   = "N4993";
		$g_conf_site_key  = "35xG2X4wrJbnm2mf2KYqGTF__";
	} else {
		$g_conf_site_cd   = "N4994";
		$g_conf_site_key  = "0xYZedEpC7hI5TRpAgjZc5T__";
	}
    ...
    if ( $tran_cd != "" )
    {
        $c_PayPlus->mf_do_tx( "", $g_conf_home_dir, $g_conf_site_cd, $g_conf_site_key, $tran_cd, "",
                              ...
                              $cust_ip, $g_conf_log_level, 1, 0, $g_conf_log_path ); // 응답 전문 처리
...
?>
    ...
    <form name="pay_info" method="post" action="./result.php">
		<input type="hidden" name="nation_no"         value="<?=$nation_no ?>">			<!--나라 구분-->
        ...
        <input type="hidden" name="good_name"       value="<?=$good_name        ?>" accept-charset="euc-kr">    <!-- 상품명 -->
        <input type="hidden" name="buyr_name"       value="<?=$buyr_name        ?>" accept-charset="euc-kr">    <!-- 주문자명 -->
