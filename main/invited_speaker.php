        ...
        success: function(res) {
            if (res.code == 200) {
                ...
                for (var i = 0; i < res["total_count"]; i++) {
                    ...
                    html += "<div class='clearfix2' style='display:flex;flex-wrap: wrap;'>";

                    html += "<div class='speaker_img" + logo_img +
                        "' style='width:238px; height:267px;background:url(" + "\"" + list[
                    ...
                    html += "<div class='red_box'>" + list['title'] + "</div>"
                    html += "<div class='blue_box'>" + list['affiliation'] + "</div>"
                    html += "<div class='lecture_title'>";
                    html += "<p class='plenary'>" + list['session_type'] + "</p>";

                    if (list['session_type2']) {
                        html += "<p class='plenary'>" + list['session_type2'] + "</p>";
                        html += list['title2'];
                    }
                    html += "</div>";
                    html += "</div>";
