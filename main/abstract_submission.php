									...
									<table class="table green_table">
										<tbody>
											<tr>
												...
												<td class="half">
													<select name="department" id=""><?= get_department_option_text($department_list, $af['department']) ?></select>
													<input type="text" name="department_other" class="en_num_keyup" maxlength="255" value="<?= $af['department_detail'] ?>" <?= ($af['department'] == 16) ? "" : "disabled" ?>>
												</td>

											</tr>
											<tr>
												<th class="border_left">Affiliation <span class="red_txt">*</span></th>
												<td><input type="text" name="affiliation" class="" maxlength="255" value="<?= $af['affiliation'] ?>"></td>
											</tr>
											<tr>
												<th class="border_left">Country <span class="red_txt">*</span></th>
												<td>
													<select class="required" name="country"><?= get_nation_option_text($nation_list, $af['nation_no']) ?></select>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<div class="x_scroll au" data-order="<?= $au['order'] ?>" data-key="<?= $key ?>">
										...
										<tbody>
											<tr>
												...
												<th class="border_left radios" colspan="4">
													<input type="radio" class="radio" id="ssy<?= $key ?>" name="same_signup_yn" value="<?= $key ?>" <?= $same_signup_flag ? "checked" : "" ?>>
													<label for="ssy<?= $key ?>">Same as sign-up information<span class="red_txt">*</span></label>
													<input type="radio" class="radio" id="py<?= $key ?>" name="presenting_yn" value="<?= $key ?>" <?= $presenting_flag ? "checked" : "" ?>>
													<label for="py<?= $key ?>">Presenting author<span class="red_txt">*</span></label>
													<input type="radio" class="radio" id="cy<?= $key ?>" name="corresponding_yn" value="<?= $key ?>" <?= $corresponding_flag ? "checked" : "" ?>>
													<label for="cy<?= $key ?>">Corresponding author<span class="red_txt">*</span></label>
												</th>
											</tr>
											<tr>
												<th class="border_left">First name <span class="red_txt">*</span></th>
												<td><input type="text" name="name_en_first" class="en_name_keyup" maxlength="60" value="<?= $au['first_name'] ?>"></td>
												<th class="border_left">Last name <span class="red_txt">*</span></th>
												<td><input type="text" name="name_en_last" class="en_name_keyup" maxlength="60" value="<?= $au['last_name'] ?>"></td>
											</tr>
											<!-- <tr>
									...
									<td><input type="text" name="affiliation_ko" class="ko_num_keyup" maxlength="60" value="<?= $au['affiliation_kor'] ?>"></td>
											...
											<tr>
												...
												<td><input type="text" name="email" class="email" maxlength="60" value="<?= $au['email'] ?>"></td>
												...
												<td class="sel_3">
													...
													?>
														<select name="" id="" class="au_affiliation"><?= get_affiliation_option_text(count($af_list), $selected) ?></select>
													<?php
													}
													?>
												</td>
											...
											<tr>
												<th class="border_left">Phone Number <span class="red_txt" name="mobile_required"><?= ($presenting_flag || $corresponding_flag) ? "*" : "" ?></span>
												</th>
												<td colspan="3" class="phone_2">
													<input type="text" name="nation_tel" class="num_keyup" maxlength="5" value="<?= $au["nation_tel"] ?>" placeholder="82">
													<input type="text" name="mobile" class="num_keyup" maxlength="60" value="<?= $au['mobile'] ?>">
												</td>
											</tr>
										</tbody>
									</table>
