			...
			<div class="x_scroll">
				<table class="table table_responsive">
                    ...
                    ?>
						...
						<tr class="centerT">
							<td class="text_l white_normal"><?=strip_tags(htmlspecialchars_decode($sb["title"], ENT_QUOTES))?></td>
							...
							<td>
								...
								<?php
									if ($sb['status'] == 0) {
								?>
								<button type="button" class="btn modify_btn" onclick="javascript:location.href='./abstract_submission.php?idx=<?=$sb["idx"]?>'">Modify</button>
								<?php
									} else {
								?>
								<button type="button" class="btn modify_btn" onclick="javascript:location.href='./abstract_submission3.php?idx=<?=$sb["idx"]?>'">Detail</button>
								<?php
									}
								?>
